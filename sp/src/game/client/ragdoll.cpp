...
static ConVar ragdoll_sleepaftertime( "ragdoll_sleepaftertime", "15.0f", 0, "After this many seconds of being basically stationary, the ragdoll will go to sleep." );
