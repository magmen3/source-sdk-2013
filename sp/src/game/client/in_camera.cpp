...
static ConVar cam_snapto( "cam_snapto", "1", FCVAR_ARCHIVE | FCVAR_CHEAT);	 // snap to thirdperson view
...
ConVar cam_idealdist( "cam_idealdist", "-1", FCVAR_ARCHIVE | FCVAR_CHEAT );	 // thirdperson distance
...
static ConVar c_mindistance( "c_mindistance",   "-1", FCVAR_ARCHIVE| FCVAR_CHEAT );
