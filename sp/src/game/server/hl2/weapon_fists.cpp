...
ConVar    sk_npc_dmg_fists		( "sk_npc_dmg_fists","0");
...
float CWeaponFists::GetDamageForActivity( Activity hitActivity )
{
	...
	return sk_npc_dmg_fists.GetFloat();
}
...
//-----------------------------------------------------------------------------
// Attempt to lead the target (needed because citizens can't hit manhacks with the fists!)
//-----------------------------------------------------------------------------
ConVar sk_fists_lead_time( "sk_fists_lead_time", "0.9" );
...
int CWeaponFists::WeaponMeleeAttack1Condition( float flDot, float flDist )
{
	...
	float dt = sk_fists_lead_time.GetFloat();
...
void CWeaponFists::HandleAnimEventMeleeHit( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	...
	CBaseEntity *pHurt = pOperator->CheckTraceHullAttack( pOperator->Weapon_ShootPosition(), vecEnd, 
		Vector(-16,-16,-16), Vector(36,36,36), sk_npc_dmg_fists.GetFloat(), DMG_CLUB, 0.75 );
