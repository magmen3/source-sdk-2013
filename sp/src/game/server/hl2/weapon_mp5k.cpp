...
#ifdef MAPBASE
// Allows Weapon_BackupActivity() to access the MP5K's activity table.
acttable_t *GetMP5KActtable()
{
	return CWeaponMP5K::m_acttable;
}

int GetMP5KActtableCount()
{
	return ARRAYSIZE(CWeaponMP5K::m_acttable);
}
#endif
...
void CWeaponMP5K::AddViewKick( void )
{
	...
	#define	MAX_VERTICAL_KICK	0.7f	//Degrees
