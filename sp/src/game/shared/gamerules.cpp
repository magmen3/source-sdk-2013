...
static CViewVectors g_DefaultViewVectors(
	...
	Vector(-9, -9, 0 ),		//VEC_HULL_MIN (m_vHullMin)
	Vector( 9,  9,  72 ),		//VEC_HULL_MAX (m_vHullMax)
													
	Vector(-9, -9, 0 ),		//VEC_DUCK_HULL_MIN (m_vDuckHullMin)
	Vector( 9,  9,  36 ),		//VEC_DUCK_HULL_MAX	(m_vDuckHullMax)
