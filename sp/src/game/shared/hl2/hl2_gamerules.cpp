...
ConVar	sk_dmg_take_scale1( "sk_dmg_take_scale1", "0.8", FCVAR_REPLICATED );
ConVar	sk_dmg_take_scale2( "sk_dmg_take_scale2", "1.35", FCVAR_REPLICATED );
#ifdef HL2_EPISODIC
	ConVar	sk_dmg_take_scale3( "sk_dmg_take_scale3", "1.85", FCVAR_REPLICATED );
#else
